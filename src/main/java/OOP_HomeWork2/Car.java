...
public class Car {
    ...
    public void switchGear(int number) {
        this.transmission.switchGear(number);
    }
    ...
    public static void main(String[] args) {
        Car car = new Car();
        car.base.checkAll();
        car.conditioner.check();
        car.doorLeftFront.check();
        car.doorLeftRear.check();
        car.doorRightFront.check();
        car.doorRightRear.check();
        car.light.check();
        car.steering.check();
        car.window.check();
        car.wipers.check();
        car.start();
        car.drive();
        car.engine.throttleUpInternal(20);
        car.turnLeft(30);
        car.goingStraight();
        car.turnRight(20);
        car.goingStraight();
